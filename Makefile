...
PROJECT_REPO ?= github.com/joonvena/$(PROJECT_NAME)
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/aivens/01-delete.yaml.tmpl.
